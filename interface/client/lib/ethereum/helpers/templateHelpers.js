...
Template.registerHelper('appName', function() {
  return window.mistMode === 'mist' ? 'Mist' : 'Sagcity Wallet';
});
...
Template.registerHelper('appLogo', function() {
  return (
    'file://' + window.dirname + '/icons/' + window.mistMode + '/sagesmall.png'
  );
});

Template.registerHelper('spinnerLogo', function() {
  return (
    'file://' + window.dirname + '/icons/' + window.mistMode + '/sagecity(3).png'
  );
});
